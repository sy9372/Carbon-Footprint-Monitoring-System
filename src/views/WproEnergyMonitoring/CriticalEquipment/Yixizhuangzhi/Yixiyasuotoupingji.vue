  ...
  data() {
    return {
      imgData: [
        {
          name: '乙烯DCS图1',
          url: require('@/icons/image/Ethyleneplant/yixi1.png'),
          value: 'dcs1'
        }, {
          name: '乙烯DCS图2',
          url: require('@/icons/image/Ethyleneplant/yixi2.png'),
          value: 'dcs2'
        }, {
          name: '乙烯DCS图3',
          url: require('@/icons/image/Ethyleneplant/yixi3.png'),
          value: 'dcs3'
        }, {
          name: '乙烯DCS图4',
          url: require('@/icons/image/Ethyleneplant/yixi4.png'),
          value: 'dcs4'
        }
      ],
      dataObj: [
