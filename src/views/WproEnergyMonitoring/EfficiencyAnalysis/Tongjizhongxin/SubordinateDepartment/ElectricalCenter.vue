<template>
  <div class="ElectricalCenterBox">
    <!-- 这里是电气仪表中心 -->
    <div class="ecBox">
      <img class="ecImage" src="@/icons/image/lowpressure/Dianqiyibiaozhongxin.png">
    </div>
    <div class="ecDataSelect">
      <div class="block">
        <p>请选择日期范围 :</p>
        <el-date-picker
          v-model="value2"
...
export default {
  ...
  methods: {
    ...
    line() {
      const myChart = this.$echarts.init(document.getElementById('ecLineTable'))
      myChart.setOption({
        title: {
          left: 'center',
          text: '历史趋势'
