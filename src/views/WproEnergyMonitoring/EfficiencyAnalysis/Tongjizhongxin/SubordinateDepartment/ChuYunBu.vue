<template>
  <div class="chuYunBuBox">
    <!-- 这里是储运部 -->
    <div class="dcsBox">
      <img class="dcsImage" src="@/icons/image/lowpressure/Chuyunbu.png">
    </div>
    <div class="cybDataSelect">
      <div class="block">
        <p>请选择日期范围 :</p>
        <el-date-picker
          v-model="value2"
...
export default {
  ...
  methods: {
    ...
    line() {
      const myChart = this.$echarts.init(document.getElementById('cybLineTable'))
      myChart.setOption({
        title: {
          left: 'center',
          text: '历史趋势'
